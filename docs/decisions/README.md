...
| [0012](0012-flat-workbench-chrome.md) | Proposed; composition revisit proposed in [0022](0022-recessed-workbench-deck.md) | Flat, layered workbench chrome (tonal surfaces + hairlines, single continuous-corner scale, card language for overlays) supersedes system-material sidebars/toolbar band; native controls/accessibility retained; no Liquid Glass |
