...
| [`ensemble-onboarding.md`](ensemble-onboarding.md) | Changing the guided "New Ensemble…" sheet, its three doors, CLI gating reuse, budget-grant defaults, the universal copyable-goal paste fallback, or the template/expert-door reuse of C6's instantiation and launch paths |
