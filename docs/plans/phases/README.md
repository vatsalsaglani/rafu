...
| [Terminal Groups — compound tabs and saved layouts](terminal-groups.md) ([worktree execution](terminal-groups/README.md)) | Proposed (2026-08-15); plans only, no source work started | ADR 0004/0014/0018/0021 baseline; TG-00 must accept ADR 0023 and add targeted amendments, then TG-10 must land source contracts | One serial decision plan, one serial source-contract plan, two file-disjoint parallel waves around one serial workspace cutover, and final integration QA for one named group tab, right/down panes, directional focus, bounded sessions, and inert saved layouts |
