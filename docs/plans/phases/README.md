...
| [T-F — Notch HUD for terminal attention](terminal-notch-hud.md) | Planned (2026-07-21) | terminal-manager T-E (ADR 0016) | Notch/menu-bar HUD re-presenting the SAME bounded snippet + reply path; presentation only, no new data path |
