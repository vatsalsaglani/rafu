...
| [Terminal manager — sessions panel, hide/close, shells, attention](terminal-manager.md) | Planned (2026-07-21); staged T-A…T-E | ADR 0004/0014 terminal baseline; utility-rail pattern | ⌃` hides instead of killing; Terminals panel manages/reveals/names/colors sessions; shell choice with preferred default; bell → attention badge |
