...
| C8-04 | [C8-04-plan-gate-and-propose-merge.md](C8-04-plan-gate-and-propose-merge.md) | `conductor/c8-04-plan-gate` | Merged 2026-07-26 (`485c5af`; plan gate, propose-merge, merged state, proposals; +4 defect fixes incl. a WorkspaceSession retain cycle. GUI section L pending) |
