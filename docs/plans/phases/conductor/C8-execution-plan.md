...
| 5 | [`C8-05-skill-pack-and-settings.md`](C8-05-skill-pack-and-settings.md) | `conductor/c8-05-skill-pack` | 3 | C8-03 |
...
- **Wave 2** branches from `main` only after ALL wave-1 branches merged
  ...
  points.
- **Wave 3** branches after wave 2 fully merged. C8-04, C8-05, C8-07 run in
  parallel; owned paths are disjoint (engine+gates / resources+settings /
  sheet+commands). C8-04 additionally requires C8-06 because the plan-gate
  preview reuses `ConductorGraphModel`.
...
4. The skill pack installs from Settings and teaches exactly the shipped
   verb surface (verb version checked).
