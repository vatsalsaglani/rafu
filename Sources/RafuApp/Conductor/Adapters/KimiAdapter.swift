...
/// Kimi CLI adapter — STUB. C3 owns the real implementation
/// (`docs/plans/phases/conductor/C3-adapters-opencode-cline-kimi.md`); C0 lands only a compiling,
/// honestly-degrading shell so `ConductorAdapterRegistry` is complete and
/// C3 rewrites exactly this one file with no shared-file edits.
///
...
nonisolated struct KimiAdapter: ConductorCLIAdapter {
    ...
    /// C3 flips this once it verifies a real listing command.
