...
/// `OpenCodeAdapter` — OWNED BY PHASE C3
...
@Test("OpenCodeAdapter is registered and degrades honestly until C3 implements it")
func openCodeAdapterIsAnHonestStub() async {
...
@Test("OpenCodeAdapter agrees with itself about model discovery")
func openCodeAdapterDiscoveryFlagIsHonest() async {
