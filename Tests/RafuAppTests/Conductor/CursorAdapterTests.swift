...
/// `CursorAdapter` — OWNED BY PHASE C4
...
@Test("CursorAdapter is registered and degrades honestly until C4 implements it")
func cursorAdapterIsAnHonestStub() async {
...
@Test("CursorAdapter agrees with itself about model discovery")
func cursorAdapterDiscoveryFlagIsHonest() async {
