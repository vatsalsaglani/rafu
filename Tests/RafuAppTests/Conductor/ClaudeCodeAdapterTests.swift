...
/// `ClaudeCodeAdapter` — OWNED BY PHASE C2
...
@Test("ClaudeCodeAdapter is registered and degrades honestly until C2 implements it")
func claudeCodeAdapterIsAnHonestStub() async {
...
@Test("ClaudeCodeAdapter agrees with itself about model discovery")
func claudeCodeAdapterDiscoveryFlagIsHonest() async {
