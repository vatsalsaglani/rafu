...
actor TerminalGroupIntegrationStore {
    private var records:
...
extension TerminalGroupIntegrationStore: TerminalGroupSavedLayoutStoring {}
...
func workspaceSessionSavesAndDeletesThroughItsInjectedStore() async throws {
    ...
    #expect(session.pendingTerminalGroupSaveRequest?.proposedName == "Copy")
